...
public class Menu extends JPanel {
    private Components.MenuItem selectedMenuItem; // Référence à l'élément actuellement sélectionné
   // private final MigLayout layout;
    ...
    private final String menuItems[][] = {
        ...
        {"Tableau de Bord","Acceuil","Chiffre d'Affaire"},
        {"~GESTION~"},
        {"Clients","Liste Clients"},
        {"Devis","Liste Devis","Créer devis"},
        {"Commandes","Liste Commande","Bon de Commande"},
        {"Facture","Liste Facture"},
        {"~REGLEMENT~"},
        {"Paiement","Acompte","Facture"},
        {"~STOCK MATERIAUX~"},
        {"Materiaux","Profilé Alu","Vitre","Joint","Roulette","Paumelle","Serrure","Poignée","Vis Assemblage","Operateur","Clips","Rivettes"},
        {"~CONTACT~"},
  ...
  public boolean isShowMenu() {
   ...
   public void setShowMenu(boolean showMenu) {
    ...
    private final String headerName = "KINTANA SERVICE";

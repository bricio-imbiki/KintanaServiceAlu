...
public class ScrollBarWin11UI extends BasicScrollBarUI {
    ...
    public void installUI(JComponent c) {
        ...
        // c.setForeground(new Color(94, 139, 231));
...
protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
    ...
    int minThumbHeight = 20; // Adjust this value as needed
    ...
    if (scrollbar.getOrientation() == JScrollBar.VERTICAL) {
        ...
        // Ensure thumb height is not smaller than the minimum
    ...
    protected void paintTrack(Graphics g, JComponent c, Rectangle trackBounds) {
       ...
       g2.setColor(new Color(0,0,0,0).brighter());

...
public class ComboRoundedUI extends BasicComboBoxUI {
...
protected void paintComponent(Graphics g) {
    ...
    int arc = 15; // Ajuster pour modifier le rayon des coins
    g2.fillRoundRect(2, 0, getWidth()-1, getHeight()-1, arc, arc);
...
public void paintBorder(Component cmpnt, Graphics grphcs, int x, int y, int width, int height) {
    ...
    int arc = 15; // Ajuster pour modifier le rayon des coins
    g2.drawRoundRect(x+1, y, width - 2, height - 1, arc, arc);
    g2.dispose();
}
